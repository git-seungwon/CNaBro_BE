...
Revision ID: d793a6e0a024
Revises: e7e2643de6ef
Create Date: 2024-11-14 20:02:39.942163
...
revision: str = 'd793a6e0a024'
down_revision: Union[str, None] = 'e7e2643de6ef'
...
def upgrade() -> None:
    ...
    op.add_column('user', sa.Column('provider_id', sa.String(length=30), nullable=True, comment='OaOauth 제공자가 local이 아닌 경우에만 작성'))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('user', sa.Column('user_nickname', mysql.VARCHAR(length=20), nullable=False, comment='유저 닉네임'))
