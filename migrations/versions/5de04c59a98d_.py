...
Revision ID: 5de04c59a98d
Revises: 
Create Date: 2024-10-10 20:24:30.915011
...
def upgrade() -> None:
    ...
    sa.Column('user_nickname', sa.String(length=10), nullable=False, comment='유저 닉네임'),
    sa.Column('email', sa.String(length=30), nullable=False, comment='유저 이메일'),
    ...
    sa.Column('score', sa.LargeBinary(length=2), nullable=False, comment='점수'),
    sa.ForeignKeyConstraint(['user_id'], ['user.user_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
